...
async def download_ytdlp(url: str, dest_dir: str, progress_cb=None, audio_only=False, cookies_path=None) -> str:
    ...
    if cookies_path and os.path.exists(cookies_path):
        ...
        logger.info(f"[yt-dlp] Cookies utilisés : {cookies_path}")
